...
# --- NEW SE-RESNET MODEL DEFINITION ---
...
def create_se_resnet34(num_classes=5):
...
if __name__ == "__main__":
    ...
    # NOTE: Ensure the 'data_directory' path is correct for your system.
    # If the script and the 'IF25-4041-dataset' folder are in the same directory, this should work.
    ...
    print("\n" + "="*60)
    print("INITIALIZING SE-RESNET-34 MODEL FOR TRAINING")
    print("="*60)
    model = create_se_resnet34(num_classes=num_classes).to(device)
    ...
    best_val_acc = 0.0
    model_save_path = 'se_resnet34_best_model.pth'
    
    print(f"{'Epoch':<10}{'Train Loss':<15}{'Train Acc (%)':<18}{'Val Loss':<15}{'Val Acc (%)':<15}")
    print("-" * 75)
    ...
    for epoch in range(num_epochs):
        ...
        print(f"{epoch+1:<10}{train_loss:<15.4f}{train_acc:<18.2f}{val_loss:<15.4f}{val_acc:<15.2f}")
    ...
    best_model = create_se_resnet34(num_classes=num_classes).to(device)
